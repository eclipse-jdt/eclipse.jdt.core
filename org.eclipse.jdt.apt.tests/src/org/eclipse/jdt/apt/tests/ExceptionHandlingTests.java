...
public class ExceptionHandlingTests extends APTTestBase {
	...
	public void testWrapperClassForPrimitiveValue() throws Exception {
		...
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from Boolean to boolean", testPath));
	...
	public void testOtherPrimitiveForBooleanValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from int to boolean", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
	...
	public void testStringForBooleanValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from String to boolean", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
	...
	public void testArrayForBooleanValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from Object[] to boolean", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
	...
	public void testPrimitiveForStringValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from boolean to String", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
	...
	public void testOtherClassForStringValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from Object to String", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
	...
	public void testPrimitiveForArrayValue() throws Exception
	{
		...
		fullBuild( project.getFullPath() );
		expectingOnlySpecificProblemFor(testPath, new Problem("Test", "Type mismatch: cannot convert from char to String[]", testPath));
		assertEquals(ProcessorTestStatus.NO_ERRORS, ProcessorTestStatus.getErrors());
	}
