...
class ASTConverter {
	...
	protected InfixExpression.Operator getOperatorFor(int operatorID) {
		switch (operatorID) {
			...
			case org.eclipse.jdt.internal.compiler.ast.OperatorIds.NumberOfTables :
			...
			case org.eclipse.jdt.internal.compiler.ast.OperatorIds.MINUS_MINUS :
				throw new IllegalArgumentException("Not an InfixExpression: operatorID="+operatorID+ " MINUS_MINUS="+org.eclipse.jdt.internal.compiler.ast.OperatorIds.MINUS_MINUS ); //$NON-NLS-1$ //$NON-NLS-2$
		}
		throw new IllegalArgumentException("unknown operatorID="+operatorID+ " MINUS_MINUS="+org.eclipse.jdt.internal.compiler.ast.OperatorIds.MINUS_MINUS ); //$NON-NLS-1$ //$NON-NLS-2$
	}
