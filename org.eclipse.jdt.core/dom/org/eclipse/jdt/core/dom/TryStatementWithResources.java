...
/**
 * Try with resources statement AST node type.
 *
 * <pre>
 * TryStatement:
 *     <b>try</b> ( Resources )
 ...
 */
public class TryStatementWithResources extends Statement {
	...
	public static final ChildPropertyDescriptor BODY_PROPERTY =
		new ChildPropertyDescriptor(TryStatementWithResources.class, "body", Block.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
	...
	public static final ChildListPropertyDescriptor CATCH_CLAUSES_PROPERTY =
		new ChildListPropertyDescriptor(TryStatementWithResources.class, "catchClauses", CatchClause.class, CYCLE_RISK); //$NON-NLS-1$
	...
	public static final ChildListPropertyDescriptor RESOURCES_PROPERTY =
		new ChildListPropertyDescriptor(TryStatementWithResources.class, "resources", VariableDeclarationExpression.class, CYCLE_RISK); //$NON-NLS-1$
	...
	public static final ChildPropertyDescriptor FINALLY_PROPERTY =
		new ChildPropertyDescriptor(TryStatementWithResources.class, "finally", Block.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
	...
	static {
		...
		createPropertyList(TryStatementWithResources.class, propertyList);
	...
	private ASTNode.NodeList resources =
		new ASTNode.NodeList(RESOURCES_PROPERTY);
	 ...
	 */
	TryStatementWithResources(AST ast) {
		super(ast);
		supportedOnlyIn4();
	}
	...
	final int getNodeType0() {
		return TRY_STATEMENT_WITH_RESOURCES;
	}
	...
	ASTNode clone0(AST target) {
		TryStatementWithResources result = new TryStatementWithResources(target);
	...
	/**
	 * Returns the live ordered list of resources for this try with resources statement.
	 *
	...
	int treeSize() {
		return
			...
			+ this.resources.listSize()
			+ (this.catchClauses == null ? 0 : this.catchClauses.listSize())
