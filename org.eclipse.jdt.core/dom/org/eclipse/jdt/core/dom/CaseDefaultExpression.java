...
public class CaseDefaultExpression extends Expression {
	...
	static {
		...
		createPropertyList(CaseDefaultExpression.class, propertyList);
	...
	final int getNodeType0() {
		return CASE_DEFAULT_EXPRESSION;
	}

	@Override
	ASTNode clone0(AST target) {
		CaseDefaultExpression result = new CaseDefaultExpression(target);
