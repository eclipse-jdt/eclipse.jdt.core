...
public class FormattingPreferences {
	...
	private static FormattingPreferences Defaults;
	private static FormattingPreferences SunSettings;
	...
	public static FormattingPreferences getDefault() {
		if (Defaults == null) {
			Defaults = new FormattingPreferences();
	...
	public static FormattingPreferences getSunSetttings() {
		if (SunSettings == null) {
			SunSettings = new FormattingPreferences();
