...
public class JavaIndex {
	// Version constants
	static final int CURRENT_VERSION = Nd.version(1, 33);
	static final int MAX_SUPPORTED_VERSION = Nd.version(1, 33);
	static final int MIN_SUPPORTED_VERSION = Nd.version(1, 33);
