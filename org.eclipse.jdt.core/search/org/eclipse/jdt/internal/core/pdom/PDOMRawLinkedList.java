 ...
 * @since 3.12
 */
public class PDOMRawLinkedList {
	 ...
	 */
	public PDOMRawLinkedList(PDOM pdom, long record, int elementRecordSize, int firstBlockRecordCount, int recordsPerBlock,
