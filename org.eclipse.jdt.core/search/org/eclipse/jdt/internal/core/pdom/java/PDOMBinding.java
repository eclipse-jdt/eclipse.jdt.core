...
public abstract class PDOMBinding extends PDOMNode implements IAdaptable {
	...
	public static final StructDef<PDOMBinding> type;
	...
	private static final PDOMAnnotation[] NO_ANNOTATIONS = new PDOMAnnotation[0];

	public PDOMBinding(PDOM pdom, long record) {
		super(pdom, record);
	}

	public PDOMBinding(PDOM pdom, PDOMResourceFile resource) {
		super(pdom);
	...
	public void setFile(PDOMResourceFile file) {
		FILE.put(getPDOM(), this.address, file);
	}

	public PDOMResourceFile getFile() {
