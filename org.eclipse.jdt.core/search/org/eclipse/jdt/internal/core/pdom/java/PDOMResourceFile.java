 ...
 * @since 3.12
 */
public class PDOMResourceFile extends PDOMTreeNode {
	public static final FieldSearchKey<JavaIndex> FILENAME;
	public static final FieldOneToMany<PDOMBinding> ALL_NODES;
	...
	public static final StructDef<PDOMResourceFile> type;

	static {
		type = StructDef.create(PDOMResourceFile.class, PDOMTreeNode.type);
		FILENAME = FieldSearchKey.create(type, JavaIndex.FILES);
		ALL_NODES = FieldOneToMany.create(type, PDOMBinding.FILE, 16);
	...
	public PDOMResourceFile(PDOM dom, long record) {
		super(dom, record);
	}

	public PDOMResourceFile(PDOM pdom) {
		super(pdom, null);
	}
