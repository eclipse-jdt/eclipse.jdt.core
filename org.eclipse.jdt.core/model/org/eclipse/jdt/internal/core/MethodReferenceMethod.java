...
public class MethodReferenceMethod extends SourceMethod {
	...
	MethodReferenceMethod(JavaElement parent, String name, String key, int sourceStart, String returnType, SourceMethodElementInfo elementInfo) {
		super(parent, name, new String[0]);
	...
	public boolean equals(Object o) {
		if (!(o instanceof MethodReferenceMethod)) return false;
		MethodReferenceMethod that = (MethodReferenceMethod) o;
	...
	public void getHandleMemento(StringBuffer buff, boolean serializeParent) {
		if (serializeParent) {
			((MethodReferenceExpression) getParent()).getHandleMemento(buff, true, false);
		}
	...
	public void getHandleMemento(StringBuffer buff) {
		...
		// referenced method and reference expression cannot share the same memento - add a trailing discriminator.
		appendEscapedDelimiter(buff, getHandleMementoDelimiter());
	}

	@Override
	protected char getHandleMementoDelimiter() {
		return JavaElement.JEM_METHOD_REFERENCE_METHOD;
	}
