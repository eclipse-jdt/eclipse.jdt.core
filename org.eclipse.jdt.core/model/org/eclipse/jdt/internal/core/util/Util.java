...
public class Util {
	 ...
	 * TODO (olivier) remove after M7
	 */
	public static String getConvertedDeprecatedValue(Preferences preferences, String key) {
		return getConvertedValue(preferences, key);
	}
	...
	private static String getConvertedValue(Preferences preferences, String key) {
		...
		if (DefaultCodeFormatterConstants.FORMATTER_METHOD_DECLARATION_ARGUMENTS_ALIGNMENT.equals(key)) {
			...
			value = preferences.getString(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_INVOCATION);
		} else if (DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_MESSAGE_SEND.equals(key)) {
