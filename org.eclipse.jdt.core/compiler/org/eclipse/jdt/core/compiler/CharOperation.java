...
public final class CharOperation {
	...
	/**
	 * Answers true if a sub-pattern matches the subpart of the given name using CamelCase rules, or
	 * false otherwise. char[] CamelCase matching does NOT accept explicit wild-cards '*' and '?'. Can match 
	 * only subset of name/pattern, considering end positions as non-inclusive.
