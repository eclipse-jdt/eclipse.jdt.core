...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false);  
    ...
    case 399 : if (DEBUG) { System.out.println("ReferenceExpression ::= PrimitiveType Dims COLON_COLON"); }  //$NON-NLS-1$
		    consumeReferenceExpressionPrimitiveTypeForm();  
			break;
 
    case 400 : if (DEBUG) { System.out.println("ReferenceExpression ::= Name Dimsopt COLON_COLON..."); }  //$NON-NLS-1$
