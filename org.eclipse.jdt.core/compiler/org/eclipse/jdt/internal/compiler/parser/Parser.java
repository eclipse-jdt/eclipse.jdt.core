...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);  
    ...
    case 391 : if (DEBUG) { System.out.println("SwitchLabels ::= SwitchLabels SwitchLabel"); }  //$NON-NLS-1$
     ...
     case 398 : if (DEBUG) { System.out.println("SwitchExprArm -> SwitchExprThrowDefaultArm"); }  //$NON-NLS-1$
		    consumeSwitchExprArm();  
			break;
 
     case 399 : if (DEBUG) { System.out.println("SwitchExprExprArm ::= SwitchLabelExpr Expression..."); }  //$NON-NLS-1$
		    consumeSwitchExprExprArm();  
			break;
 
     case 400 : if (DEBUG) { System.out.println("SwitchExprBreakArm ::= SwitchLabelExpr BreakExpression"); }  //$NON-NLS-1$
		    consumeSwitchExprBreakArm();  
			break;
 
     case 401 : if (DEBUG) { System.out.println("SwitchExprThrowArm ::= SwitchLabelExpr ThrowExpression"); }  //$NON-NLS-1$
		    consumeSwitchExprThrowArm();  
			break;
 
     case 402 : if (DEBUG) { System.out.println("SwitchExprExprDefaultArm ::= SwitchLabelDefaultExpr..."); }  //$NON-NLS-1$
		    consumeSwitchExprThrowDefaultArm();  
			break;
 
     case 403 : if (DEBUG) { System.out.println("SwitchExprThrowDefaultArm ::= SwitchLabelDefaultExpr..."); }  //$NON-NLS-1$
		    consumeSwitchExprExprDefaultArm();  
			break;
 
     case 404 : if (DEBUG) { System.out.println("SwitchLabelDefaultExpr ::= default BeginCaseExpr ARROW"); }  //$NON-NLS-1$
		    consumeDefaultLabelExpr();  
			break;
 
     case 405 : if (DEBUG) { System.out.println("SwitchLabelExpr ::= SwitchLabelCaseLhs BeginCaseExpr..."); }  //$NON-NLS-1$
		    consumeCaseLabelExpr();  
			break;
 
     case 406 : if (DEBUG) { System.out.println("SwitchLabelCaseLhs ::= case ConstantExpressions"); }  //$NON-NLS-1$
		    consumeSwitchLabelCaseLhs();  
			break;
 
    case 407 : if (DEBUG) { System.out.println("WhileStatement ::= while LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementWhile() ;  
			break;
 
    case 408 : if (DEBUG) { System.out.println("WhileStatementNoShortIf ::= while LPAREN Expression..."); }  //$NON-NLS-1$
		    consumeStatementWhile() ;  
			break;
 
    case 409 : if (DEBUG) { System.out.println("DoStatement ::= do Statement while LPAREN Expression..."); }  //$NON-NLS-1$
		    consumeStatementDo() ;  
			break;
 
    case 410 : if (DEBUG) { System.out.println("ForStatement ::= for LPAREN ForInitopt SEMICOLON..."); }  //$NON-NLS-1$
		    consumeStatementFor() ;  
			break;
 
    case 411 : if (DEBUG) { System.out.println("ForStatementNoShortIf ::= for LPAREN ForInitopt..."); }  //$NON-NLS-1$
		    consumeStatementFor() ;  
			break;
 
    case 412 : if (DEBUG) { System.out.println("ForInit ::= StatementExpressionList"); }  //$NON-NLS-1$
		    consumeForInit() ;  
			break;
 
    case 416 : if (DEBUG) { System.out.println("StatementExpressionList ::= StatementExpressionList..."); }  //$NON-NLS-1$
		    consumeStatementExpressionList() ;  
			break;
 
    case 417 : if (DEBUG) { System.out.println("AssertStatement ::= assert Expression SEMICOLON"); }  //$NON-NLS-1$
		    consumeSimpleAssertStatement() ;  
			break;
 
    case 418 : if (DEBUG) { System.out.println("AssertStatement ::= assert Expression COLON Expression"); }  //$NON-NLS-1$
		    consumeAssertStatement() ;  
			break;
 
    case 419 : if (DEBUG) { System.out.println("BreakStatement ::= break SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreak() ;  
			break;
 
    case 420 : if (DEBUG) { System.out.println("BreakStatement ::= BreakExpression SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;  
			break;
 
    case 421 : if (DEBUG) { System.out.println("BreakExpression ::= break Expression"); }  //$NON-NLS-1$
