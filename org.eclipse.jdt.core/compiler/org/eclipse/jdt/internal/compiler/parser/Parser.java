...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);  
    ...
    case 397 : if (DEBUG) { System.out.println("SwitchExprArms ::= SwitchExprArms SwitchExprArm"); }  //$NON-NLS-1$
		    consumeSwitchExprArms() ;  
			break;
 
     case 403 : if (DEBUG) { System.out.println("SwitchExprArm -> SwitchExprThrowDefaultArm"); }  //$NON-NLS-1$
		    consumeSwitchExprArm();  
			break;
 
     case 404 : if (DEBUG) { System.out.println("SwitchExprBlockArm ::= SwitchLabelExpr Block"); }  //$NON-NLS-1$
		    consumeSwitchExprBlockArm();  
			break;
 
     case 405 : if (DEBUG) { System.out.println("SwitchExprExprArm ::= SwitchLabelExpr Expression..."); }  //$NON-NLS-1$
		    consumeSwitchExprExprArm();  
			break;
 
     case 406 : if (DEBUG) { System.out.println("SwitchExprBreakArm ::= SwitchLabelExpr BreakExpression"); }  //$NON-NLS-1$
		    consumeSwitchExprBreakArm();  
			break;
 
     case 407 : if (DEBUG) { System.out.println("SwitchExprThrowArm ::= SwitchLabelExpr ThrowExpression"); }  //$NON-NLS-1$
		    consumeSwitchExprThrowArm();  
			break;
 
     case 408 : if (DEBUG) { System.out.println("SwitchExprExprDefaultArm ::= SwitchLabelDefaultExpr..."); }  //$NON-NLS-1$
		    consumeSwitchExprExprDefaultArm();  
			break;
 
     case 409 : if (DEBUG) { System.out.println("SwitchExprThrowDefaultArm ::= SwitchLabelDefaultExpr..."); }  //$NON-NLS-1$
		    consumeSwitchExprThrowDefaultArm();  
			break;
 
     case 410 : if (DEBUG) { System.out.println("SwitchLabelDefaultExpr ::= default BeginCaseExpr ARROW"); }  //$NON-NLS-1$
		    consumeDefaultLabelExpr();  
			break;
 
     case 411 : if (DEBUG) { System.out.println("SwitchLabelExpr ::= SwitchLabelCaseLhs BeginCaseExpr..."); }  //$NON-NLS-1$
		    consumeCaseLabelExpr();  
			break;
 
     case 412 : if (DEBUG) { System.out.println("SwitchLabelCaseLhs ::= case ConstantExpressions"); }  //$NON-NLS-1$
    ...
    case 426 : if (DEBUG) { System.out.println("BreakStatement ::= BreakExpression SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;  
			break;
 
    case 427 : if (DEBUG) { System.out.println("BreakExpression ::= break Expression"); }  //$NON-NLS-1$
    ...
    case 431 : if (DEBUG) { System.out.println("ThrowStatement ::= ThrowExpression SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementThrow();  
			break;
 
    case 432 : if (DEBUG) { System.out.println("ThrowExpression ::= throw Expression"); }  //$NON-NLS-1$
    ...
    case 438 : if (DEBUG) { System.out.println("TryStatementWithResources ::= try ResourceSpecification"); }  //$NON-NLS-1$
		    consumeStatementTry(true, true);  
			break;
 
    case 439 : if (DEBUG) { System.out.println("ResourceSpecification ::= LPAREN Resources ;opt RPAREN"); }  //$NON-NLS-1$
		    consumeResourceSpecification();  
			break;
 
    case 440 : if (DEBUG) { System.out.println(";opt ::="); }  //$NON-NLS-1$
		    consumeResourceOptionalTrailingSemiColon(false);  
			break;
 
    case 441 : if (DEBUG) { System.out.println(";opt ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeResourceOptionalTrailingSemiColon(true);  
			break;
 
    case 442 : if (DEBUG) { System.out.println("Resources ::= Resource"); }  //$NON-NLS-1$
		    consumeSingleResource();  
			break;
 
    case 443 : if (DEBUG) { System.out.println("Resources ::= Resources TrailingSemiColon Resource"); }  //$NON-NLS-1$
		    consumeMultipleResources();  
			break;
 
    case 444 : if (DEBUG) { System.out.println("TrailingSemiColon ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeResourceOptionalTrailingSemiColon(true);  
			break;
 
    case 445 : if (DEBUG) { System.out.println("Resource ::= Type PushModifiers VariableDeclaratorId..."); }  //$NON-NLS-1$
		    consumeResourceAsLocalVariableDeclaration();  
			break;
 
    case 446 : if (DEBUG) { System.out.println("Resource ::= Modifiers Type PushRealModifiers..."); }  //$NON-NLS-1$
		    consumeResourceAsLocalVariableDeclaration();  
			break;
 
    case 447 : if (DEBUG) { System.out.println("Resource ::= Name"); }  //$NON-NLS-1$
		    consumeResourceAsLocalVariable();  
			break;
 
    case 448 : if (DEBUG) { System.out.println("Resource ::= FieldAccess"); }  //$NON-NLS-1$
		    consumeResourceAsFieldAccess();  
			break;
 
    case 450 : if (DEBUG) { System.out.println("ExitTryBlock ::="); }  //$NON-NLS-1$
		    consumeExitTryBlock();  
			break;
 
    case 452 : if (DEBUG) { System.out.println("Catches ::= Catches CatchClause"); }  //$NON-NLS-1$
		    consumeCatches();  
			break;
 
    case 453 : if (DEBUG) { System.out.println("CatchClause ::= catch LPAREN CatchFormalParameter RPAREN"); }  //$NON-NLS-1$
		    consumeStatementCatch() ;  
			break;
 
    case 455 : if (DEBUG) { System.out.println("PushLPAREN ::= LPAREN"); }  //$NON-NLS-1$
		    consumeLeftParen();  
			break;
 
    case 456 : if (DEBUG) { System.out.println("PushRPAREN ::= RPAREN"); }  //$NON-NLS-1$
		    consumeRightParen();  
			break;
 
    case 461 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= this"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayThis();  
			break;
 
    case 462 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Expression_NotName..."); }  //$NON-NLS-1$
		    consumePrimaryNoNewArray();  
			break;
 
    case 463 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Name PushRPAREN"); }  //$NON-NLS-1$
...
//	SwitchExprThrowDefaultArm ::= SwitchLabelDefaultExpr Expression ';'
	consumeStatementThrow();
	processSwitchExprArm(SwitchExprArm.EXPR_KIND.DEFAULT_THROW);
}
protected void consumeSwitchExprExprDefaultArm() {
//	SwitchExprThrowDefaultArm ::= SwitchLabelDefaultExpr Expression ';'
	processSwitchExprExprArm(SwitchExprArm.EXPR_KIND.DEFAULT_EXPR);
}
...
protected void consumeSwitchExprBlockArm() {
	processSwitchExprArm(SwitchExprArm.EXPR_KIND.BLOCK);
}
protected void consumeSwitchExprArm() {
	// do nothing
}
private void processSwitchExprArm(SwitchExprArm.EXPR_KIND kind) {
	this.astLengthPtr--;
	...
	SwitchExprArm arm = new SwitchExprArm(kind, l, r, l.sourceStart, r.sourceEnd);
	pushOnAstStack(arm);
}
