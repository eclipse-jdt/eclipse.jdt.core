...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);  
    ...
    case 418 : if (DEBUG) { System.out.println("BreakStatement ::= BreakExpression SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;  
			break;
 
    case 419 : if (DEBUG) { System.out.println("BreakExpression ::= break Expression"); }  //$NON-NLS-1$
