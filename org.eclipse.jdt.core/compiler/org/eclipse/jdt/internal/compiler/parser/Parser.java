...
protected void consumeRule(int act) {
  switch ( act ) {
    ...
    case 99 : if (DEBUG) { System.out.println("ModuleHeader ::= module UnannotatableName"); }  //$NON-NLS-1$
		    consumeModuleHeader();  
			break;
    ...
    case 108 : if (DEBUG) { System.out.println("SingleRequiresModuleName ::= requires..."); }  //$NON-NLS-1$
		    consumeSingleRequiresModuleName();  
			break;
 
    case 109 : if (DEBUG) { System.out.println("RequiresModifieropt ::= PublicModifier"); }  //$NON-NLS-1$
		    consumeModifiers();  
			break;
 
    case 110 : if (DEBUG) { System.out.println("RequiresModifieropt ::="); }  //$NON-NLS-1$
		    consumeDefaultModifiers();  
			break;
 
    case 112 : if (DEBUG) { System.out.println("ExportsStatement ::= SingleExportsPkgName..."); }  //$NON-NLS-1$
		    consumeExportsStatement();  
			break;
 
    case 114 : if (DEBUG) { System.out.println("ExportTargetopt ::= to ExportTargetNameList"); }  //$NON-NLS-1$
		    consumeExportTarget();  
			break;
 
    case 115 : if (DEBUG) { System.out.println("ExportTargetNameList ::= UnannotatableName"); }  //$NON-NLS-1$
		    consumeSingleExportsTargetName();  
			break;
 
    case 116 : if (DEBUG) { System.out.println("ExportTargetNameList ::= ExportTargetNameList COMMA..."); }  //$NON-NLS-1$
		    consumeExportsTargetNameList();  
			break;
 
    case 117 : if (DEBUG) { System.out.println("SingleExportsPkgName ::= exports UnannotatableName"); }  //$NON-NLS-1$
		    consumeSingleExportsPkgName();  
			break;
 
    case 118 : if (DEBUG) { System.out.println("UsesStatement ::= uses Name SEMICOLON"); }  //$NON-NLS-1$
