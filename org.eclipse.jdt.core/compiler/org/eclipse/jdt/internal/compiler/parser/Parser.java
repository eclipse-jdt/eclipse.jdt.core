...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);  
    ...
    case 395 : if (DEBUG) { System.out.println("SwitchExpression ::= switch LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
     ...
     case 399 : if (DEBUG) { System.out.println("SwitchLabeledRule ::= SwitchLabeledBreakStatement"); }  //$NON-NLS-1$
     ...
     case 403 : if (DEBUG) { System.out.println("SwitchLabeledBreakStatement ::= SwitchLabelExpr..."); }  //$NON-NLS-1$
		    consumeSwitchLabeledBreakStatement();  
			break;
    ...
    case 420 : if (DEBUG) { System.out.println("BreakStatement ::= break Expression SEMICOLON"); }  //$NON-NLS-1$
...
protected void consumeSwitchLabeledBreakStatement() {
