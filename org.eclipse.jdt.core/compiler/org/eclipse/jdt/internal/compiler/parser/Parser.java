...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);  
    ...
    case 364 : if (DEBUG) { System.out.println("EmptyStatement ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyStatement();  
			break;
 
    case 365 : if (DEBUG) { System.out.println("LabeledStatement ::= Label COLON Statement"); }  //$NON-NLS-1$
		    consumeStatementLabel() ;  
			break;
 
    case 366 : if (DEBUG) { System.out.println("LabeledStatementNoShortIf ::= Label COLON..."); }  //$NON-NLS-1$
		    consumeStatementLabel() ;  
			break;
 
    case 367 : if (DEBUG) { System.out.println("Label ::= Identifier"); }  //$NON-NLS-1$
		    consumeLabel() ;  
			break;
 
     case 368 : if (DEBUG) { System.out.println("ExpressionStatement ::= StatementExpression SEMICOLON"); }  //$NON-NLS-1$
    ...
    case 391 : if (DEBUG) { System.out.println("SwitchLabels ::= SwitchLabels SwitchLabel"); }  //$NON-NLS-1$
     ...
     case 392 : if (DEBUG) { System.out.println("SwitchLabel ::= SwitchLabelCase COLON"); }  //$NON-NLS-1$
		    consumeCaseLabel();  
			break;
 
     case 393 : if (DEBUG) { System.out.println("SwitchLabel ::= SwitchLabelDefault COLON"); }  //$NON-NLS-1$
		    consumeDefaultLabel();  
			break;
 
     case 394 : if (DEBUG) { System.out.println("SwitchLabelCase ::= case LiteralExpressions"); }  //$NON-NLS-1$
		    consumeCase();  
			break;
 
     case 395 : if (DEBUG) { System.out.println("SwitchLabelDefault ::= default"); }  //$NON-NLS-1$
		    consumeDefault();  
			break;
 
    case 398 : if (DEBUG) { System.out.println("SwitchExpressionArm ::= SwitchExpressionLabel..."); }  //$NON-NLS-1$
		    consumeSwitchExpressionArm() ;  
			break;
 
     case 399 : if (DEBUG) { System.out.println("SwitchExpressionLabel ::= SwitchLabelCase ARROW"); }  //$NON-NLS-1$
		    consumeSwitchExpressionLabelCase();  
			break;
 
     case 400 : if (DEBUG) { System.out.println("SwitchExpressionLabel ::= SwitchLabelDefault ARROW"); }  //$NON-NLS-1$
		    consumeSwitchExpressionLabelDefault();  
			break;
 
     case 402 : if (DEBUG) { System.out.println("LiteralExpressions ::= LiteralExpression COMMA..."); }  //$NON-NLS-1$
		    consumeLiteralExpressions();  
			break;
    ...
    case 418 : if (DEBUG) { System.out.println("BreakStatement ::= break Identifier SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;  
			break;
 
    case 419 : if (DEBUG) { System.out.println("BreakExpressionStatement ::= BeginBreakExpr break..."); }  //$NON-NLS-1$
		    consumeStatementBreakWithExpression() ;  
			break;
...
protected void consumeStatementBreakWithExpression() {
	// TODO: implement
}
...
protected void consumeSwitchExpressionArm() {
	// TODO: implement
}
protected void consumeSwitchExpressionLabelCase() {
	// TODO: implement
}
protected void consumeLiteralExpressions() {
	// TODO: implement
}
protected void consumeSwitchExpressionLabelDefault() {
	// TODO: implement
}
