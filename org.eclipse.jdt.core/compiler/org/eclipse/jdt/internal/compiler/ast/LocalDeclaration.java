...
public void checkModifiers(){
	...
	if ( ((modifiers &  AccJustFlag) | AccFinal) != AccFinal )
		...
		modifiers = (modifiers & (-AccAlternateModifierProblem-1)) | AccModifierProblem ;
}
/**
...
public void resolve(BlockScope scope) {
	...
	if (initialization != null) {
		...
		binding.constant = binding.isFinal() ? initialization.constant.castTo((tb.id << 4) + initialization.constant.typeID()) : NotAConstant;
	}
}
