...
public abstract class AstNode implements BaseTypes, CompilerModifiers, TypeConstants, TypeIds {
	...
	public final static int Bit5 = 0x10; 			// value for return (binary expression) | need runtime checkcast (cast expression)
	...
	public static final int NeedRuntimeCheckCastMASK = Bit5;
