...
public class ASTRewritingRecordDeclarationTest extends ASTRewritingTest {
	...
	public void testRecord_005() throws Exception {
		...
		String str1 = """
			package test1;
			public record C() implements A, B{
