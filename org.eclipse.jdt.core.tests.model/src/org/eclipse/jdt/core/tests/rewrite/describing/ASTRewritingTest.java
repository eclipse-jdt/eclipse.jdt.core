...
public class ASTRewritingTest extends AbstractJavaModelTests {
	...
	protected void setUpProjectAbove27() throws Exception {
		if (this.apiLevel == AST_INTERNAL_JLS27) {
			this.project1.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_27);
			this.project1.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_27);
			this.project1.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_27);
		}
		setUpProjectAbove28();
	}
	protected void setUpProjectAbove28() throws Exception {
		if (this.apiLevel == AST_INTERNAL_JLS28) {
			this.project1.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_28);
			this.project1.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_28);
			this.project1.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_28);
		}
	}
