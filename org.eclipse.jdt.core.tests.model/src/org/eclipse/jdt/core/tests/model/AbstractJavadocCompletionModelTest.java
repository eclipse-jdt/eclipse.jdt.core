...
public abstract class AbstractJavadocCompletionModelTest extends AbstractJavaModelCompletionTests implements JavadocTagConstants {
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING<br>+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY<br>= 11 */
	protected final static int R_DRINRJ= R_DEFAULT+R_RESOLVED+R_INTERESTING+R_NON_RESTRICTED+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING<br>+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY<br>= 14 */
	protected final static int R_DRIUNRJ= R_DEFAULT+R_RESOLVED+R_INTERESTING+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE<br>+R_NON_RESTRICTED+R_JAVA_LIBRARY<br>= 21 */
	protected static final int R_DRICNRJ = R_DEFAULT+R_RESOLVED+R_INTERESTING+R_CASE+R_NON_RESTRICTED+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE<br>+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY<br>= 24 */
	protected static final int R_DRICUNRJ = R_DEFAULT+R_RESOLVED+R_INTERESTING+R_CASE+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_EXACT_NAME<br>+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY<br>= 28 */
	protected static final int R_DRICENUNRJ = R_DEFAULT+R_RESOLVED+R_INTERESTING+R_CASE+R_EXACT_NAME+R_UNQUALIFIED+R_NON_RESTRICTED+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE<br>+R_NON_RESTRICTED+R_EXCEPTION+R_JAVA_LIBRARY<br>= 41 */
	protected static final int R_DRICNREJ = R_DRICNR+R_EXCEPTION+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_EXACT_NAME<br>+R_NON_RESTRICTED+R_EXCEPTION+R_JAVA_LIBRARY<br>= 45 */
	protected static final int R_DRICUNREJ = R_DRICUNR+R_EXCEPTION+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE<br>+R_NON_RESTRICTED+R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY<br>= 51 */
	protected static final int R_DRICNREETJ = R_DRICNR+R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_UNQUALIFIED<br>+R_NON_RESTRICTED+R_EXACT_EXPECTED_TYPE+R_EXCEPTION
	 * +R_JAVA_LIBRARY<br>= 74 */
	protected static final int R_DRICUNREETEJ = R_DRICUNR+R_EXACT_EXPECTED_TYPE+R_EXCEPTION+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_NON_RESTRICTED<br>+R_EXCEPTION+R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY<br>= 71 */
	protected static final int R_DRICNREEETJ = R_DRICNRE+R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_UNQUALIFIED<br>+R_NON_RESTRICTED+R_EXCEPTION<br>
	 * +R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY<br>= 74 */
	protected static final int R_DRICUNREEETJ = R_DRICUNRE+R_EXACT_EXPECTED_TYPE+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE<br>+R_NON_RESTRICTED+R_INLINE_TAG+R_JAVA_LIBRARY<br>= 52 */
	protected static final int R_DRICNRITJ = R_DRICNR+R_INLINE_TAG+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_UNQUALIFIED<br>+R_NON_RESTRICTED+R_INLINE_TAG+R_JAVA_LIBRARY<br>= 55 */
	protected static final int R_DRICUNRITJ = R_DRICUNR+R_INLINE_TAG+R_JAVA_LIBRARY;
	...
	/** R_DEFAULT+R_RESOLVED<br>+R_INTERESTING+R_CASE+R_NON_RESTRICTED<br>+R_EXACT_EXPECTED_TYPE+R_INLINE_TAG
	 * +R_JAVA_LIBRARY<br>= 82 */
	protected static final int R_DRICNREETITJ = R_DRICNREET+R_INLINE_TAG+R_JAVA_LIBRARY;
