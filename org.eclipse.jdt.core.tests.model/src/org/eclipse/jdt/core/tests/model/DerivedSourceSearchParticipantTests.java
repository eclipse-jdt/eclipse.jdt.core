 ...
 * and the {@link DerivedSourceSearchParticipantRegistry}.
 */
public class DerivedSourceSearchParticipantTests extends ModifyingResourceTests {
	...
	public void testRegistryHasParticipantForLangx() {
		assertTrue("Registry should have participant for langx",
				DerivedSourceSearchParticipantRegistry.hasParticipant("langx"));
	}
	...
	public void testRegistryNoParticipantForUnknownExtension() {
		assertFalse("Registry should not have participant for unknown_ext",
				DerivedSourceSearchParticipantRegistry.hasParticipant("unknown_ext"));
	}
	...
	public void testRegistryGetParticipantSingleton() {
		SearchParticipant p1 = DerivedSourceSearchParticipantRegistry.getParticipant("langx");
		...
		SearchParticipant p2 = DerivedSourceSearchParticipantRegistry.getParticipant("langx");
	...
	public void testGetFileExtension() {
		assertEquals("kt", DerivedSourceSearchParticipantRegistry.getFileExtension("Foo.kt"));
		assertEquals("langx", DerivedSourceSearchParticipantRegistry.getFileExtension("Bar.langx"));
		assertEquals("java", DerivedSourceSearchParticipantRegistry.getFileExtension("Baz.java"));
		assertNull(DerivedSourceSearchParticipantRegistry.getFileExtension("noextension"));
	}
	...
	public void testRegistryReset() {
		SearchParticipant before = DerivedSourceSearchParticipantRegistry.getParticipant("langx");
		assertNotNull(before);
		TestDerivedSourceSearchParticipant.reset();
		DerivedSourceSearchParticipantRegistry.reset();

		SearchParticipant after = DerivedSourceSearchParticipantRegistry.getParticipant("langx");
		assertNotNull(after);
