...
public class ReconcilerTests21WithReleaseOption extends ModifyingResourceTests {

	protected ICompilationUnit workingCopy;
	protected ProblemRequestor problemRequestor;
	static final int JLS_LATEST = AST.JLS21;

	public ReconcilerTests21WithReleaseOption(String name) {
		super(name);
	}
	// Use this static initializer to specify subset for tests
	// All specified tests which do not belong to the class are skipped...
	static {
	//	TESTS_NAMES = new String[] { "testIssue2108" };
	}
	public static Test suite() {
		return buildModelTestSuite(ReconcilerTests21WithReleaseOption.class);
	}
	...
	public void setUp() throws Exception {
		...
		this.wcOwner = new WorkingCopyOwner() {
			public IProblemRequestor getProblemRequestor(ICompilationUnit unit) {
				return ReconcilerTests21WithReleaseOption.this.problemRequestor;
			}
		};
	...
	public void setUpSuite() throws Exception {
		...
		// This test is only effective with a JDK higher than 21
		...
		project21.setOption(JavaCore.COMPILER_RELEASE, JavaCore.ENABLED);
