...
public void test011_problem_categories() {
	try {
	    ...
	    expectedProblemAttributes.put("CaseLabelWithPatternMustHaveExactlyOnePattern", new ProblemAttributes(CategorizedProblem.CAT_INTERNAL));
...
public void test012_compiler_problems_tuning() {
	try {
	    ...
	    expectedProblemAttributes.put("CaseLabelWithPatternMustHaveExactlyOnePattern", SKIP);
