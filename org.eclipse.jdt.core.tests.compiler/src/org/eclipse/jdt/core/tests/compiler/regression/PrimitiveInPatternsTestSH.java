...
//		TESTS_NAMES = new String[] { "testPrimitivePatternInSwitch" };
	...
	void checkPreviewFlag(String[] testFiles) {
		...
		try {
			verifyClassFile("version 28 : 72.65535", className, ClassFileBytesDisassembler.SYSTEM);
	...
	public void testIdentity() throws IOException, ClassFormatException {
		...
		verifyClassFile("version 28 : 72.65535", "X.class", ClassFileBytesDisassembler.SYSTEM);
	}
