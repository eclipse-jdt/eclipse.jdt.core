...
public void _test114() {
    this.runConformTest(
        new String[] {
			...
			"		test(\"LocalEnumTest\");\n" +
			"		test(\"LocalEnumTest$EnumA\");\n" +
			"		test(\"LocalEnumTest$EnumB\");\n" +
			"		test(\"LocalEnumTest$EnumB2\");\n" +
			"		test(\"LocalEnumTest$EnumB3\");\n" +
			...
			"		test(\"LocalEnumTest$EnumC3\");\n" +
			"		test(\"LocalEnumTest$EnumD\");\n" +
			"	}\n" +
			"	static void _test(String className) throws Exception {\n" +
...
public void _test165() throws Exception {
	this.runNegativeTest(
		new String[] {
			"X.java", // =================
			"class Other {\n" +
...
public void _test166() throws Exception {
	this.runNegativeTest(
		new String[] {
			"X.java", // =================
			"public enum X {\n" +
...
public void _test182() throws Exception {
	Map customOptions = getCompilerOptions();
...
//https://bugs.eclipse.org/bugs/show_bug.cgi?id=328519
public void _test183() throws Exception {
	Map customOptions = getCompilerOptions();
	customOptions.put(CompilerOptions.OPTION_ReportUnusedLocal, CompilerOptions.ERROR);
	customOptions.put(CompilerOptions.OPTION_PreserveUnusedLocal, CompilerOptions.OPTIMIZE_OUT);
	this.runConformTest(
...
//https://bugs.eclipse.org/bugs/show_bug.cgi?id=328519
public void _test184() throws Exception {
	Map customOptions = getCompilerOptions();
	customOptions.put(CompilerOptions.OPTION_ReportUnusedLocal, CompilerOptions.ERROR);
	customOptions.put(CompilerOptions.OPTION_PreserveUnusedLocal, CompilerOptions.OPTIMIZE_OUT);
	this.runConformTest(
...
public void _test434442() {
	...
	this.runConformTest(new String[] {
			...
			"  		A, B;\n" +
			"	}\n" +
			"  public default void _test(Letter letter) {\n" +
			"    switch (letter) {\n" +
			"      case A:\n" +
