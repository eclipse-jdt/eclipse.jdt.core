...
public class Java22ElementsTests extends TestCase {
	...
	public void testGetEnumConstantBody01Javac() throws IOException {
		...
		internalTestWithBinary(compiler, MODULE_PROC, "22", "testGetEnumConstantBody01", null, "java22", true);
	}
	...
	public void testGetEnumConstantBody02Javac() throws IOException {
		JavaCompiler compiler = ToolProvider.getSystemJavaCompiler();
		internalTestWithBinary(compiler, MODULE_PROC, "22", "testGetEnumConstantBody02", null, "java22", true);
	}
