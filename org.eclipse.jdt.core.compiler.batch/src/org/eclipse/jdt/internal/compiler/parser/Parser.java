...
protected void consumeStringTemplate() {
	System.out.println("Inside consumeTemplateExpression()");
	this.scanner.templateCount = 0;
	StringLiteral tail = (StringLiteral) this.expressionStack[this.expressionPtr--];
	this.expressionLengthPtr--;
	//int length = this.expressionLengthStack[this.expressionLengthPtr--];
	int segments = this.expressionLengthStack[this.expressionLengthPtr--];
	StringLiteral[] literals = new StringLiteral[segments + 1];
	literals[segments] = tail;
	Expression[] values = new Expression[segments];
	while (segments > 0) {
		segments--;
		values[segments] = this.expressionStack[this.expressionPtr--];
		literals[segments] = (StringLiteral) this.expressionStack[this.expressionPtr--];
	}
	StringTemplate template = new StringTemplate(literals, values);
	System.out.println("StringTemplate: " + template);
	template.sourceStart = literals[0].sourceStart;
	template.sourceEnd = literals[segments].sourceEnd;
	pushOnExpressionStack(template);
}
protected void consumeTemplateExpression() {
	System.out.println("Inside consumeTemplateExpression()");
	NameReference ref = getUnspecifiedReference(true);
	TemplateExpression exp = new TemplateExpression(
			ref,
			(StringTemplate) this.expressionStack[this.expressionPtr]);
	exp.sourceStart = ref.sourceStart;
	exp.sourceEnd = exp.sourceEnd;
	pushOnExpressionStack(exp);
}
protected void consumeEmbeddedExpression() {
	concatExpressionLists();
//	Expression exp = this.expressionStack[this.expressionPtr--];
//	StringLiteral frag = (StringLiteral) this.expressionStack[this.expressionPtr--];
//	StringTemplate template = new StringTemplate(new StringLiteral[] {frag}, new Expression[] {exp});
//	System.out.println("Inside consumeEmbeddedExpression()");
//	System.out.println(template);
//	pushOnAstStack(template);
}
...
protected void consumeRule(int act) {
	 ...
	 consumeMethodDeclaration(false, false);
	    ...
	    case 375 : if (DEBUG) { System.out.println("EmbeddedExpression ::= Expression"); }  //$NON-NLS-1$
			    consumeEmbeddedExpression();
				break;

	    case 380 : if (DEBUG) { System.out.println("StringTemplate ::= StringTemplateBegin..."); }  //$NON-NLS-1$
			    consumeStringTemplate();
				break;
	    ...
	    case 772 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInitRecord ::= for LPAREN..."); }  //$NON-NLS-1$
	    ...
	    case 774 : if (DEBUG) { System.out.println("EnhancedForStatementHeader ::=..."); }  //$NON-NLS-1$
			    consumeEnhancedForStatementHeader();
				break;

	    case 775 : if (DEBUG) { System.out.println("SingleStaticImportDeclaration ::=..."); }  //$NON-NLS-1$
			    consumeImportDeclaration();
				break;

	    case 776 : if (DEBUG) { System.out.println("SingleStaticImportDeclarationName ::= import static Name"); }  //$NON-NLS-1$
			    consumeSingleStaticImportDeclarationName();
				break;

	    case 777 : if (DEBUG) { System.out.println("StaticImportOnDemandDeclaration ::=..."); }  //$NON-NLS-1$
			    consumeImportDeclaration();
				break;

	    case 778 : if (DEBUG) { System.out.println("StaticImportOnDemandDeclarationName ::= import static..."); }  //$NON-NLS-1$
			    consumeStaticImportOnDemandDeclarationName();
				break;

	    case 779 : if (DEBUG) { System.out.println("TypeArguments ::= LESS TypeArgumentList1"); }  //$NON-NLS-1$
			    consumeTypeArguments();
				break;

	    case 780 : if (DEBUG) { System.out.println("OnlyTypeArguments ::= LESS TypeArgumentList1"); }  //$NON-NLS-1$
			    consumeOnlyTypeArguments();
				break;

	    case 782 : if (DEBUG) { System.out.println("TypeArgumentList1 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
			    consumeTypeArgumentList1();
				break;

	    case 784 : if (DEBUG) { System.out.println("TypeArgumentList ::= TypeArgumentList COMMA TypeArgument"); }  //$NON-NLS-1$
			    consumeTypeArgumentList();
				break;

	    case 785 : if (DEBUG) { System.out.println("TypeArgument ::= ReferenceType"); }  //$NON-NLS-1$
			    consumeTypeArgument();
				break;

	    case 789 : if (DEBUG) { System.out.println("ReferenceType1 ::= ReferenceType GREATER"); }  //$NON-NLS-1$
			    consumeReferenceType1();
				break;

	    case 790 : if (DEBUG) { System.out.println("ReferenceType1 ::= ClassOrInterface LESS..."); }  //$NON-NLS-1$
			    consumeTypeArgumentReferenceType1();
				break;

	    case 792 : if (DEBUG) { System.out.println("TypeArgumentList2 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
			    consumeTypeArgumentList2();
				break;

	    case 795 : if (DEBUG) { System.out.println("ReferenceType2 ::= ReferenceType RIGHT_SHIFT"); }  //$NON-NLS-1$
			    consumeReferenceType2();
				break;

	    case 796 : if (DEBUG) { System.out.println("ReferenceType2 ::= ClassOrInterface LESS..."); }  //$NON-NLS-1$
			    consumeTypeArgumentReferenceType2();
				break;

	    case 798 : if (DEBUG) { System.out.println("TypeArgumentList3 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
			    consumeTypeArgumentList3();
				break;

	    case 801 : if (DEBUG) { System.out.println("ReferenceType3 ::= ReferenceType UNSIGNED_RIGHT_SHIFT"); }  //$NON-NLS-1$
			    consumeReferenceType3();
				break;

	    case 802 : if (DEBUG) { System.out.println("Wildcard ::= TypeAnnotationsopt QUESTION"); }  //$NON-NLS-1$
			    consumeWildcard();
				break;

	    case 803 : if (DEBUG) { System.out.println("Wildcard ::= TypeAnnotationsopt QUESTION WildcardBounds"); }  //$NON-NLS-1$
			    consumeWildcardWithBounds();
				break;

	    case 804 : if (DEBUG) { System.out.println("WildcardBounds ::= extends ReferenceType"); }  //$NON-NLS-1$
			    consumeWildcardBoundsExtends();
				break;

	    case 805 : if (DEBUG) { System.out.println("WildcardBounds ::= super ReferenceType"); }  //$NON-NLS-1$
			    consumeWildcardBoundsSuper();
				break;

	    case 806 : if (DEBUG) { System.out.println("Wildcard1 ::= TypeAnnotationsopt QUESTION GREATER"); }  //$NON-NLS-1$
			    consumeWildcard1();
				break;

	    case 807 : if (DEBUG) { System.out.println("Wildcard1 ::= TypeAnnotationsopt QUESTION..."); }  //$NON-NLS-1$
			    consumeWildcard1WithBounds();
				break;

	    case 808 : if (DEBUG) { System.out.println("WildcardBounds1 ::= extends ReferenceType1"); }  //$NON-NLS-1$
			    consumeWildcardBounds1Extends();
				break;

	    case 809 : if (DEBUG) { System.out.println("WildcardBounds1 ::= super ReferenceType1"); }  //$NON-NLS-1$
			    consumeWildcardBounds1Super();
				break;

	    case 810 : if (DEBUG) { System.out.println("Wildcard2 ::= TypeAnnotationsopt QUESTION RIGHT_SHIFT"); }  //$NON-NLS-1$
			    consumeWildcard2();
				break;

	    case 811 : if (DEBUG) { System.out.println("Wildcard2 ::= TypeAnnotationsopt QUESTION..."); }  //$NON-NLS-1$
			    consumeWildcard2WithBounds();
				break;

	    case 812 : if (DEBUG) { System.out.println("WildcardBounds2 ::= extends ReferenceType2"); }  //$NON-NLS-1$
			    consumeWildcardBounds2Extends();
				break;

	    case 813 : if (DEBUG) { System.out.println("WildcardBounds2 ::= super ReferenceType2"); }  //$NON-NLS-1$
	    ...
	    case 816 : if (DEBUG) { System.out.println("WildcardBounds3 ::= extends ReferenceType3"); }  //$NON-NLS-1$
			    consumeWildcardBounds3Extends();
				break;

	    case 817 : if (DEBUG) { System.out.println("WildcardBounds3 ::= super ReferenceType3"); }  //$NON-NLS-1$
			    consumeWildcardBounds3Super();
				break;

	    case 818 : if (DEBUG) { System.out.println("TypeParameterHeader ::= TypeAnnotationsopt Identifier"); }  //$NON-NLS-1$
			    consumeTypeParameterHeader();
				break;

	    case 819 : if (DEBUG) { System.out.println("TypeParameters ::= LESS TypeParameterList1"); }  //$NON-NLS-1$
			    consumeTypeParameters();
				break;

	    case 821 : if (DEBUG) { System.out.println("TypeParameterList ::= TypeParameterList COMMA..."); }  //$NON-NLS-1$
	    ...
	    case 877 : if (DEBUG) { System.out.println("InstanceofExpression_NotName ::= Name InstanceofRHS"); }  //$NON-NLS-1$
		...
		case TokenNameCharacterLiteral :
			pushOnExpressionStack(
				new CharLiteral(
					...
					this.scanner.currentPosition - 1));
			break;
		case TokenNameStringTemplateEnd :
			StringLiteral stringLiteral = createStringLiteral(
					this.scanner.getCurrentStringFragment(true),
					this.scanner.startPosition + 1,
					this.scanner.currentPosition,
					0);
			pushOnExpressionStack(stringLiteral);
			break;
		case TokenNameStringFragment :
			stringLiteral = createStringLiteral(
					this.scanner.getCurrentStringFragment(false),
					this.scanner.startPosition + 1,
					this.scanner.currentPosition,
					0);
			pushOnExpressionStack(stringLiteral);
...
//			if (this.scanner.lookBack[0] == TokenNameBeginStringTemplateLastArg) {
//				this.scanner.templateCount++;
//				break;
//			}
			//$FALL-THROUGH$
